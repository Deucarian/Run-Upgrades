# Run-Upgrades: definition workflow
...
3. Use its buttons to exercise draft upgrades, select first offered upgrade.
4. Inspect the configured hosts and triggers, then open
   [RunUpgradesWorkflow.cs](../Samples~/DefinitionWorkflow/Runtime/RunUpgradesWorkflow.cs). It is the caller
...
- **Draft upgrades**: `RunUpgradesWorkflow.Draft()`.
- **Select first offered upgrade**: `RunUpgradesWorkflow.Select()`.
